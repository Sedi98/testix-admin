...
const ExamParameters = (props: any) => {
    console.log('ExamParameters rendered, props:', props)
    const { onNext } = props
    ...
    `}>
                ...
                <div className="flex justify-between">
                    ...
                    <Button
                        onClick={() => {
                            console.log('Davam et clicked, onNext:', !!onNext)
                            if (onNext) {
                                onNext()
                            } else {
                                navigate("/create-exam/exam-summary")
                            }
                        }}
