    ...
    <div className="rounded-xl border border-neutral-stroke bg-white p-5">
      <div className="flex items-start justify-between gap-4">
        <div className="flex items-center gap-4">
          <div className="flex size-14 items-center justify-center rounded-full border border-neutral-stroke bg-primary-0 text-2xl font-normal">
            A.S
          </div>
          <div>
            <h2 className="text-xl font-semibold">Aynur Salmanzade</h2>
      ...
      <div className="mt-5 grid grid-cols-1 gap-5 lg:grid-cols-2">
        <ReadonlyField label="Ad Soyad" value="Aynur Salmanzadə" />
        <ReadonlyField label="Telefon nömrəsi" value={student.phone} />
      ...
      <div className="mt-5 grid grid-cols-1 gap-5 lg:grid-cols-2">
        <ReadonlyField
          label="Tamamlanmış imtahan"
          value="12 imtahan"
          valueClassName="text-green-700"
        />
        <ReadonlyField
          label="Gözləmədə olan imtahan"
          value="2 imtahan"
