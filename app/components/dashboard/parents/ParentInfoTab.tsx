  ...
  return (
    <div className="rounded-xl border border-neutral-stroke bg-white p-5">
      ...
      <div className="mt-5 grid grid-cols-1 gap-5 lg:grid-cols-2">
        <ReadonlyField label="Ad Soyad" value={parent.name} />
        <ReadonlyField label="Telefon nömrəsi" value={parent.phone} />
      ...
      <div className="mt-5 grid grid-cols-1 gap-5 lg:grid-cols-2">
        <ReadonlyField label="Övlad sayı" value="1 övlad" />
        <ReadonlyField label="Alınan imtahanlar" value="4" />
        <ReadonlyField
          label="Koin balansı"
          value="1,230 koin"
          icon={<Coins size={18} />}
